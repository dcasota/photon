...
%changelog
* Mon Mar 31 2026 Factory AI Bot <factory-droid[bot]@users.noreply.github.com> 2.7-8
- Remove install-time SELinux relabel (moved to STIG first-boot service)
* Mon Mar 30 2026 Factory AI Bot <factory-droid[bot]@users.noreply.github.com> 2.7-7
