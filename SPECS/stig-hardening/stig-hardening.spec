...
%changelog
* Mon Mar 31 2026 Factory AI Bot <factory-droid[bot]@users.noreply.github.com> 2.1-6
...
- Add first-boot SELinux relabel service (installer kernel rejects lsetxattr)
* Mon Mar 30 2026 Factory AI Bot <factory-droid[bot]@users.noreply.github.com> 2.1-5
...
- Fix PHTN-50-000192 pam_faillock PAM stack corruption under Ansible 2.20
