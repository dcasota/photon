...
Source1:        license.txt
%include %{SOURCE1}
Patch0:         0001-Use-command-v-instead-of-which.patch
Patch1:         0001-set-clean_requirements_on_remove-1-in-shipped-tdnf.c.patch
...
%changelog
* Tue Oct 28 2025 Oliver Kurth <oliver.kurth@broadcom.com> 3.6.1-1
- update to 3.6.1
